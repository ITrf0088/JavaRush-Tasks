...
public class MathExpression {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(toSolve("sin(2*(-5+1.5*4)+28)")); //expected output 0.5 6
        System.out.println(toSolve("tan(2025 ^ 0.5)")); //expected output 1 2
        System.out.println(toSolve("1+(1+(1+1)*(1+1))*(1+1)+1"));  // 12 8
        System.out.println(toSolve("-2^(-2)"));  // 0.25 3
        System.out.println(toSolve("-(-2^(-2))+2+(-(-2^(-2)))")); // 1.5 10
        System.out.println(toSolve("(-2)*(-2)")); // 4 3
        System.out.println(toSolve("(-2)/(-2)")); // 1 3
        System.out.println(toSolve("sin(-30)")); // -0.5 2
        System.out.println(toSolve("cos(-30)")); // 0.87 2
        System.out.println(toSolve("tan(-30)")); // -0.58 2
        System.out.println(toSolve("2+8*(9/4-1.5)^(1+1)")); // 6.48 6
        System.out.println(toSolve("tan(44+sin(89-cos(180)^2))")); // 1 6
        System.out.println(toSolve("0+0.304"));
        System.out.println(toSolve("sin(2*(-5+1.5*4)+28)")); // 0.5 6
        System.out.println(toSolve("tan(2025 ^ 0.5 )    ")); // 1 2
        System.out.println(toSolve("-cos(180)^2")); // -1 3
        System.out.println(toSolve("cos(3 + 19*3)")); // 0.5
    }
    ...
    public static String toSolve(String expr){
        ...
        return String.valueOf(number)+" "+getCountofOperation(expr);
    }
