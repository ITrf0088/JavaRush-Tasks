...
public class View extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Хисоби бози: " + controller.getScore(), 80, 465);

        if (isGameWon) {
            JOptionPane.showMessageDialog(this, "Табрик 2048!");
        } else if (isGameLost) {
            JOptionPane.showMessageDialog(this, "Табрик шумо натовонистед :(");
        }
    }
